...
exports.appRouter = (0, trpc_1.router)({
    ...
    payment: payment_route_1.paymentRouter,
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        query: validators_1.InfiniteQuerySchema,
    }))
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var query, cursor, sort, limit, queryOptions, payload, parsedQueryOptions, page, _c, items, hasNextPage, nextPage;
        var input = _b.input;
